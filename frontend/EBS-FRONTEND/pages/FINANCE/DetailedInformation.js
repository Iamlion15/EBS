      ...
      <div>
        ...
        <table className="table table-borderless font-monospace">
          <tbody>
            ...
            <tr>
              <td>request was submitted on :</td>
              <td>{formatDateToCustomFormat(data.createdAt)} </td>
            </tr>
            <tr>
              <td>Proposed item by EBS and its cost:</td>
              <td><span className=" text-primary" style={{marginRight:"60px"}}>{data.vendoritem.itemName}</span>  {data.vendoritem.itemPrice}RWF</td>
            </tr>
            <tr>
              <td>was Approved by EBS on :</td>
              <td>{formatDateToCustomFormat(data.EBS_Approval.timeOfApproval)} </td>
            </tr>
            <tr>
              <td>Approved? :</td>
